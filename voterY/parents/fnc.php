...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered Fundraising Coordinator</h1>
           <center>
           ...
           <option disabled selected>Select Parents Group</option>
                ...
                <option disabled selected>FUNDRAISING COORDINATOR</option>
        ...
        function page (src){
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                       ...
                       <?php  
                    $sql = "SELECT * FROM parents WHERE position = 'Fundraising Coordinator'";
