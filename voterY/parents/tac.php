...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered TEACHER APPRECIATION COORDINATOR</h1>
           <center>
           ...
           <option disabled selected>Select Parents Group</option>
                ...
                <option disabled selected>TEACHER APPRECIATION COORDINATOR</option>
                </select>
            </center>
        ...
        function page (src){
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                       ...
                       <?php  
                    $sql = "SELECT * FROM parents WHERE position = 'Teacher Appreciation Coordinator'";
