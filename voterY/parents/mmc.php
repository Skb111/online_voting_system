...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered MEMBERSHIP COORDINATOR</h1>
           <center>
            <select onchange = "page(this.value)">
                ...
                <option disabled selected>MEMBERSHIP COORDINATOR</option>
        ...
        function page (src){
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                       ...
                       <?php  
                    $sql = "SELECT * FROM parents WHERE position = 'Membership Coordinator'";
