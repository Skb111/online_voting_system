...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered COUNSELLOR</h1>
    </heading>
           <center>
           <select onchange = "page(this.value)">
            <option disabled selected>Select Teachers Group</option>
                ...
                <option disabled selected>COUNSELLOR</option>
                ...
                <option value = "sb.php">Social Girl</option>
                </select>
            </center>
        ...
        function page (src){
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <?php  
                    $sql = "SELECT * FROM teachers WHERE position = 'Counsellor'";
