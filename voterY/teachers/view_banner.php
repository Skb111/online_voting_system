...
<div class="side-bar" 
            style="background-color: blue; font-size:25px; text-align:center; margin-top:-10px; padding-top:20px;">

                <a style="color:white; font-weight:bold; font-size:30px;">Lagos State Secondary Student Union Candidates.</a>
                </a>

<nav class="nav-menue">
            <ul>
                <li>
                <a href="../index.php" class="active">Home CANDIDATE </a>
            </li>
...
<!-- <nav class="navbar navbar-expand-lg bg-body-tertiary align-item-center  nav-menue">
  <div class="container-fluid">
    <a class="navbar-brand py-3" style="font-size:2rem;" href="index.php">Navbar</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav nav-menue">
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="../voters.php">Students</a></li>
            <li><a class="dropdown-item" href="../teachers_voters.php">Teachers</a></li>
            <li><a class="dropdown-item" href="../parents_voters.php">Parents</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
