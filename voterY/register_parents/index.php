					...
					<div class="form-body">
						...
						<form method="post" enctype="multipart/form-data">
							...
							<div class="voters_notice">
								<p><strong><i>NOTE</i>:</strong> Only parents with an ID from the admin can apply.</p>
							</div>
							<div class="form-heading">
								<center>Parents Registeration</center>
							</div>
							<div class="form-field">
								<label>Parents ID</label><br />
								<input class="form-control" type="text" name="id_number" placeholder="Parents ID" required="true">
