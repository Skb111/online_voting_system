...
include ('add_teachers_modal.php');
?>
            ...
            <div class="row">
				...
				<hr/>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
							...
							<?php
									...
									$sort = $position;
									$query = $conn->query("SELECT * FROM teachers WHERE position = '$sort'");
					...
					<div class="panel-heading">
						...
						<a href = "teachers_canvassing.php" id="back" class = "btn btn-warning" ><i class = "fa fa-refresh"> </i> Back</a>
					...
					<thead>
						<td style = "width:600px;" class = "alert alert-success">Teachers </td>
