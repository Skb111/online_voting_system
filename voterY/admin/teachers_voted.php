...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Voted Teachers Page</h3>
				...
				<?php 
                    ...
                    $count3 = $conn->query("SELECT COUNT(*) as total FROM `t_voters` WHERE `gender` = 'Male'  AND `status` =  'Voted' ")->fetch_array();
                    $count4 =  $conn->query("SELECT COUNT(*) as total FROM `t_voters` WHERE `gender` = 'Female' AND `status` =  'Voted' ")->fetch_array();
				?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										<?php 
										$query = $conn->query("SELECT * FROM t_voters where status = 'Voted'");
