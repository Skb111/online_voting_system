...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered Head Boy Candidates</h1>
           <center>
                <select onchange = "page(this.value)">
                <option disabled selected>Select Candidate Group</option>
                <option disabled selected>Head Boy</option>
        ...
        function page (src){
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div style=" display: flex; flex-wrap: wrap;  gap: 7rem; margin-left: 9rem !important;">
                        <?php  
