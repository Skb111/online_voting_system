    ...
    <heading class="voters_heading">
        <center><h1>Registered Head Girl Candidates</h1>
           <center>
                ...
                <option value = "hg.php">Health Girl</option>
        ...
        function page (src){
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
            <div style=" display: flex; flex-wrap: wrap;  gap: 7rem; margin-left: 20rem !important;">
                        <?php  
