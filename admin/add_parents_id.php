...
?>
		<script>
			...
			window.location='current_parents.php';
	</script>	
<?php
	}
	else{
			$conn->query("insert into p_ids(id_number, names, started) VALUES('$id_number', '$names', '$started')");
?>
	<script>
				...
				<h4 class="modal-title" id="myModalLabel">         
					<div class="panel panel-primary">
						<div class="panel-heading">
							<center>Enter Parents ID</center>
						</div>    
					</div>
				</h4>
			</div>
...
<div class="modal-body">										
            ...
            <div class="modal-footer">
                <a  href = "current_parents.php"><button type="button" class="btn btn-default" data-dismiss="modal">Back</button></a>
            </div>
