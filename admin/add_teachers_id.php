...
?>
		<script>
			...
			window.location='current_teachers.php';
	</script>	
<?php
	}
	else{
			$conn->query("insert into t_ids(id_number, names, started) VALUES('$id_number', '$names', '$started')");
?>
	<script>
				...
				<h4 class="modal-title" id="myModalLabel">         
					<div class="panel panel-primary">
						<div class="panel-heading">
							<center>Enter Teachers ID</center>
						</div>    
					</div>
				</h4>
			</div>
...
<div class="modal-body">										
            ...
            <div class="modal-footer">
                <a  href = "current_teachers.php"><button type="button" class="btn btn-default" data-dismiss="modal">Back</button></a>
            </div>
