...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered DRAMA AND CHOROGRAPHY</h1>
             <center>
            ...
            <option disabled selected>Select Teachers Group</option>
                ...
                <option disabled selected>DRAMA AND CHOROGRAPHY</option>
        ...
        function page (src){
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                       ...
                       <?php  
                    $sql = "SELECT * FROM teachers WHERE position = 'Drama and Chorography'";
